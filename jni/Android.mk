...
CORE_INCLUDES := $(CORE_DIR)/src/main \
					  $(CORE_DIR)/src/main/libretro \
					  $(CORE_DIR)/deps

LOCAL_C_INCLUDES := $(CORE_INCLUDES)

COREFLAGS := $(FLAGS) -Wall -DOV_EXCLUDE_STATIC_CALLBACKS -ffast-math -D_GLIBCXX_HAS_GTHREADS -DANDROID $(INCFLAGS)
